"""Fundamental Analyst Agent - Analyzes financial health and valuations."""
...
{research_data['financial_analysis'][:1500] if research_data['financial_analysis'] else ''}

## Competitive Landscape:
{research_data['competitor_analysis'][:1500] if research_data['competitor_analysis'] else ''}

## Key Risk Factors:
{research_data['risk_factors'][:1500] if research_data['risk_factors'] else ''}
"""

        analysis_prompt = f"""Provide a comprehensive fundamental analysis for {ticker}:
...
2. **Valuation Analysis** - fair/over/under valued? (Use latest market research for context)
3. **Competitive Position** - key peers comparison
4. **Key Strengths** - competitive advantages
5. **Key Weaknesses/Risks** - main concerns
6. **Long-term Investment Thesis** - fundamental recommendation

IMPORTANT: Use the Latest Market Research as your primary source for recent developments.
Be CONCISE. Do not output a long report. Focus on the most critical insights."""
