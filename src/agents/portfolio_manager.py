"""Portfolio Manager Agent - The Boss who synthesizes all analyses and makes final decisions."""
...
"""
        ...
        synthesis_prompt = f"""As the Portfolio Manager, present the TEAM's collective decision for {ticker}.
