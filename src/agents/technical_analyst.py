"""Technical Analyst Agent - Calculates and interprets technical indicators."""
...
"""
        ...
        analysis_prompt = f"""Analyze the following technical indicators for {ticker}:
...
IMPORTANT: Use the Latest Market Intelligence data for the most current chart patterns and technical developments."""
