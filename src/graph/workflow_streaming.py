"""Streaming workflow for TUI integration with real-time agent updates."""
...
async def run_analysis_streaming(
    ...
    if has_conflict:
        ...
        for round_num in range(1, 6):  # 5 rounds of debate
            ...
            tech_prompt = f"""You are the Technical Analyst.
 ...
 Be persuasive and evidence-based."""
            ...
            fund_prompt = f"""You are the Fundamental Analyst.
 ...
 Be persuasive and evidence-based."""
            ...
            sent_prompt = f"""You are the Sentiment Analyst.
