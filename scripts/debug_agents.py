#!/usr/bin/env python3
"""Debug individual agents with custom state.

Usage:
    python scripts/debug_agents.py <agent_name> <ticker> [--verbose]

Examples:
    python scripts/debug_agents.py data_scout AAPL
    python scripts/debug_agents.py technical_analyst TSLA --verbose
    python scripts/debug_agents.py fundamental_analyst MSFT
"""
