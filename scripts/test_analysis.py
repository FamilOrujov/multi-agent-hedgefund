#!/usr/bin/env python3
"""Test the Aegis Flux API endpoints.

Usage:
    python scripts/test_analysis.py [--base-url URL] [--ticker TICKER]

Examples:
    python scripts/test_analysis.py
    python scripts/test_analysis.py --ticker TSLA
    python scripts/test_analysis.py --base-url http://localhost:8080
"""
